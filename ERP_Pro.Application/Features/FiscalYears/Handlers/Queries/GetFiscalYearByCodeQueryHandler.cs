...
{
    /// <summary>
    /// معالج استعلام الحصول على سنة مالية بالرمز
    /// </summary>
    public class GetFiscalYearByCodeQueryHandler : IRequestHandler<GetFiscalYearByCodeQuery, FiscalYearDto>
    {
        private readonly IFiscalYearRepository _fiscalYearRepository;

        public GetFiscalYearByCodeQueryHandler(IFiscalYearRepository fiscalYearRepository)
        {
            _fiscalYearRepository = fiscalYearRepository;
        }

        public async Task<FiscalYearDto> Handle(GetFiscalYearByCodeQuery request, CancellationToken cancellationToken)
        {
            var fiscalYear = await _fiscalYearRepository.GetByCodeAsync(
                request.Code,
