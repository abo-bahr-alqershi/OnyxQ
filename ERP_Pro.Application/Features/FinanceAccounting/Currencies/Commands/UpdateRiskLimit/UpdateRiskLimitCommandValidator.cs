...
{
    /// <summary>
    /// مدقق لأمر تحديث حد مخاطر العملة
    /// </summary>
    public class UpdateRiskLimitCommandValidator : AbstractValidator<UpdateRiskLimitCommand>
    {
        public UpdateRiskLimitCommandValidator()
        {
            RuleFor(v => v.Id)
                .NotEmpty().WithMessage("معرف حد المخاطر مطلوب");
