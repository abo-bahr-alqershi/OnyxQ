...
{
    /// <summary>
    /// مدقق لأمر تحديث قاعدة تقريب العملة
    /// </summary>
    public class UpdateRoundingRuleCommandValidator : AbstractValidator<UpdateRoundingRuleCommand>
    {
        public UpdateRoundingRuleCommandValidator()
        {
            RuleFor(v => v.Id)
                .NotEmpty().WithMessage("معرف قاعدة التقريب مطلوب");
