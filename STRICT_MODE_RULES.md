...
## قاعدة إلزامية مشددة (جديدة):

**يُمنع منعًا باتًا إنشاء أي موديل أو أي ملف Entity/ValueObject/Event/Enum لأي موديل أو جدول غير موجود في ملف مخطط الموديلات (`table_models_mapping.txt`) تحت أي ظرف أو اجتهاد أو تقدير، وأي محاولة لذلك تعتبر مخالفة صارخة لهذه القواعد وتؤدي إلى إلغاء التنفيذ أو رفض النتيجة بالكامل.  
يجب أن يكون كل موديل وكل ملف تابع له مرتبط حرفيًا بجدول محدد في ملف مخطط الموديلات فقط، ولا يسمح بإنشاء أي موديلات أو كيانات عشوائية أو اجتهادية من خارج المخطط مهما كانت المبررات البرمجية أو المعمارية.  
هذه القاعدة أولوية مطلقة ولا يعلو عليها أي قاعدة أخرى في هذا الملف.**
...
2. **استخدم EVENTS وVALUEOBJECTS وENUMS بشكل كامل واحترافي:**  
   - **يجب التعامل مع جميع الموديلات وتوابعها (Entities, Events, ValueObjects, Enums ...) على أنها جزء من نظام ERP عملاق واحترافي.**
   - **يتوجب إبراز الذكاء والتقدم في بناء الأحداث (Domain Events) واكتشاف الأحداث الهامة والمتوقعة لكل موديل، والبحث العميق عن جميع السيناريوهات العملية والاحترافية التي قد تحدث في أنظمة ERP، وإنشاء الأحداث التي تدعم المرونة والتوسع المستقبلي.**
   - **يجب أيضًا إبراز الذكاء في اكتشاف وتجميع الحقول المنطقية في ValueObjects بشكل احترافي وذكي، وعدم الاكتفاء بالتجميع التقليدي فقط، بل تحليل المعنى الوظيفي والسياقي لكل مجموعة خصائص.**
   - **يجب توليد Enums لأي قيمة ثابتة أو اختيارية أو حالة متكررة، مع شرح تفصيلي واحترافي لكل Enum، مع الاستفادة من خبرتك في بناء الأنظمة الكبيرة.**
   - **يُمنع منعًا باتًا التدخل في حذف أو إلغاء أو اختصار أي حقل أو خاصية جلبت من مصدر الجداول (أو العلاقات)، أو حذف أي علاقة موجودة في ملفات العلاقات مهما كان السبب، ويجب تمثيلها جميعًا دون أي نقصان أو تجاهل.**
...
## قاعدة إلزامية صارمة (إضافة جديدة):

27. **يُمنع منعًا باتًا كتابة أي نموذج كود أو مثال لا يتضمّن جميع الحقول الفعلية من ملف البنية، أو الاكتفاء بعرض النمط أو الطريقة للاسترشاد فقط أو ذكر جمل توثيقية مثل:**
   - "ولكن في نموذج الكود السابق، لم أقم بعرض جميع الحقول (لضيق المساحة)، بل عرضت النمط والطريقة للاسترشاد فقط."
   - "جميع الحقول الأخرى من ملف البنية، بنفس النمط أعلاه."
   - "جميع الحقول الباقية من ملف البنية ستدرج هنا بنفس هذا النمط مع توثيق الاسم القديم."
   - **يجب كتابة كل حقل صراحةً بنوعه واسمه الجديد مع التعليق التوثيقي واسم الحقل القديم، ولا تترك أي حقل غير معرف أو مختصر أو مذكور ضمن جملة واحدة فقط.**
   - **أي نموذج كود أو ملف ينتج عن هذه القواعد يجب أن يكون مكتمل الحقول 100%، ومطابقًا لملف البنية، وأولوية هذه القاعدة رقم 1 قبل أي قاعدة أو اعتبارات أخرى.**
