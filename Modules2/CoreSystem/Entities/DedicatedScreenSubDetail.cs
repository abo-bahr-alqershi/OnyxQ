...
{
    // كيان يمثل تفاصيل شاشة مخصصة فرعية ويحتوي على معلومات الحقول والعناصر الفرعية للشاشة.
    public class DedicatedScreenSubDetail : Entity<DedicatedScreenSubDetailId>
    {
        // المعرف الفريد لتفاصيل الشاشة المخصصة الفرعية (مفتاح رئيسي).
        public DedicatedScreenSubDetailId Id { get; private set; }
        // رقم النموذج المرتبط.
        ...
        #region Methods
        // أضف هنا منطق الدومين الخاص بتفاصيل الشاشة المخصصة الفرعية
        #endregion
    }
}
