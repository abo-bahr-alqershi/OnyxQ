...
namespace ERP_Pro.Domain.ERP.Purchasing & Vendors.Events
{
    ...
    /// </summary>
    public class QuotationTypeInvoiceIssuedEvent : DomainEventBase
    {
    public QuotationTypeId QuotationTypeId { get; }
    public decimal Amount { get; }
    public string Currency { get; }

        public QuotationTypeInvoiceIssuedEvent(QuotationTypeId quotationtypeId, decimal amount, string currency)
        {
