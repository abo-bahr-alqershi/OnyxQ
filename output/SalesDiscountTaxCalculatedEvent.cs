...
namespace ERP_Pro.Domain.ERP.Sales & Customers.Events
{
    ...
    /// </summary>
    public class SalesDiscountTaxCalculatedEvent : DomainEventBase
    {
    public SalesDiscountId SalesDiscountId { get; }
    public decimal Amount { get; }
    public string Currency { get; }

        public SalesDiscountTaxCalculatedEvent(SalesDiscountId salesdiscountId, decimal amount, string currency)
        {
