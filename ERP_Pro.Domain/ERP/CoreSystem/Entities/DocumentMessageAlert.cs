...
/// <summary>
/// Represents a document message alert entity in the system.
/// يمثل كيان تنبيه رسالة المستند في النظام
/// </summary>
public sealed class DocumentMessageAlert : AggregateRoot<DocumentMessageAlertId>
{
    /// <summary>
    ...
    public static DocumentMessageAlert Create(
        int recordNumber,
        int documentTypeId,
        string messageText,
        int messageType,
        ...
        string addedTerminalName)
    {
        var alert = new DocumentMessageAlert(
            DocumentMessageAlertId.Create(recordNumber),
            documentTypeId,
            messageText,
            messageType,
            orderNumber,
        ...
        alert.RaiseDomainEvent(new DocumentMessageAlertCreatedEvent(alert));
        ...
        string updatedTerminalName)
    {
        ...
        RaiseDomainEvent(new DocumentMessageAlertUpdatedEvent(this));
    }
}