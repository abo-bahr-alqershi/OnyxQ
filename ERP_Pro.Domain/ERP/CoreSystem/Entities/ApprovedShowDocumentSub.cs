...
namespace ERP_Pro.Domain.ERP.CoreSystem.Entities
{
    /// <summary>
    /// رقم الموديل: 58
    /// اسم الجدول القديم: S_APPRVD_SHW_DOC_SUB
    /// يمثل تفاصيل مستند العرض المعتمد الفرعي.
    /// </summary>
    public class ApprovedShowDocumentSub : Entity
    {
        /** !#DOC_TYP نوع المستند */
        ...
        public ApprovedShowDocumentSub(int documentType)
        {
