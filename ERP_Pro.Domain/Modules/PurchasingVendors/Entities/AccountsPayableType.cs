...
public class AccountsPayableType : Entity<AccountsPayableTypeId>
{
    ...
    public AccountsPayableType(AccountsPayableTypeId id, decimal? typeNumberShort, decimal? accountsPayableTypeNumber)
    {
        Id = id;
        TypeNumberShort = typeNumberShort;
        AccountsPayableTypeNumber = accountsPayableTypeNumber;
    }
