...
public class QuotationPromotionSubDetail : Entity<QuotationPromotionSubDetailId>
{
    ...
    public QuotationPromotionSubDetail(QuotationPromotionSubDetailId id, decimal? recordNumber, decimal? quotationSerialFull, string itemCode)
    {
        Id = id;
        RecordNumber = recordNumber;
        QuotationSerialFull = quotationSerialFull;
        ItemCode = itemCode;
    }
