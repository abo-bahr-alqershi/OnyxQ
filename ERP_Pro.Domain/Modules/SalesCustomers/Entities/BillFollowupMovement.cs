...
public class BillFollowupMovement : Entity<BillFollowupMovementId>
{
    ...
    public BillFollowupMovement(BillFollowupMovementId id, decimal? transactionTypeShort, decimal? transactionNumber, decimal? docSer)
    {
        Id = id;
        TransactionTypeShort = transactionTypeShort;
