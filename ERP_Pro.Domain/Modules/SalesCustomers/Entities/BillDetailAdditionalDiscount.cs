...
public class BillDetailAdditionalDiscount : Entity<BillDetailAdditionalDiscountId>
{
    ...
    private readonly List<BillMasterAdditionalDiscount> _billMasterAdditionalDiscount = new List<BillMasterAdditionalDiscount>();
    ...
    public BillDetailAdditionalDiscount(BillDetailAdditionalDiscountId id)
    {
        Id = id;
    }
    ...
    /// Collection relationship: ManyToMany
    /// </summary>
    public ICollection<BillMasterAdditionalDiscount> BillMasterAdditionalDiscount => _billMasterAdditionalDiscount;
    /// <summary>
    /// Collection relationship: ManyToMany
    /// </summary>
