...
public class CustomerCommissionCalculationDetail : Entity<CustomerCommissionCalculationDetailId>
{
    ...
    private readonly List<CustomerCommissionCalculationMaster> _customerCommissionCalculationMaster = new List<CustomerCommissionCalculationMaster>();
    private readonly List<Customer> _customer = new List<Customer>();

    private CustomerCommissionCalculationDetail() { }

    public CustomerCommissionCalculationDetail(CustomerCommissionCalculationDetailId id)
    {
        Id = id;
    }
    ...
    /// Collection relationship: ManyToMany
    /// </summary>
    public ICollection<CustomerCommissionCalculationMaster> CustomerCommissionCalculationMaster => _customerCommissionCalculationMaster;
    /// <summary>
    /// Collection relationship: ManyToMany
    /// </summary>
