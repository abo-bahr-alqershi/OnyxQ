...
/// </summary>
public class OutRequestMaster : AggregateRoot<OutRequestMasterId>
{

    private OutRequestMaster() { }

    public OutRequestMaster(OutRequestMasterId id, decimal? outgoingRequestSerial)
    {
        Id = id;
        OutgoingRequestSerial = outgoingRequestSerial;
    }
