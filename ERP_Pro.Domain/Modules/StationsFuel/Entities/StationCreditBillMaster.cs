...
/// </summary>
public class StationCreditBillMaster : AggregateRoot<StationCreditBillMasterId>
{

    private StationCreditBillMaster() { }

    public StationCreditBillMaster(StationCreditBillMasterId id, decimal? docSer)
    {
        Id = id;
        DocSer = docSer;
    }
