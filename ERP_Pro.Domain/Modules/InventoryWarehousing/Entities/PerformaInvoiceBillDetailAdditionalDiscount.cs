...
public class PerformaInvoiceBillDetailAdditionalDiscount : Entity<PerformaInvoiceBillDetailAdditionalDiscountId>
{
    ...
    private readonly List<PerformaInvoiceBillMasterAdditionalDiscount> _performaInvoiceBillMasterAdditionalDiscount = new List<PerformaInvoiceBillMasterAdditionalDiscount>();
    ...
    public PerformaInvoiceBillDetailAdditionalDiscount(PerformaInvoiceBillDetailAdditionalDiscountId id)
    {
        Id = id;
    }
    ...
    /// Collection relationship: ManyToMany
    /// </summary>
    public ICollection<PerformaInvoiceBillMasterAdditionalDiscount> PerformaInvoiceBillMasterAdditionalDiscount => _performaInvoiceBillMasterAdditionalDiscount;
    /// <summary>
    /// Collection relationship: ManyToMany
    /// </summary>
