...
public class BranchWarehouseTransferDetail : Entity<BranchWarehouseTransferDetailId>
{
    ...
    private readonly List<BranchWarehouseTransferMaster> _branchWarehouseTransferMaster = new List<BranchWarehouseTransferMaster>();

    private BranchWarehouseTransferDetail() { }

    public BranchWarehouseTransferDetail(BranchWarehouseTransferDetailId id)
    {
        Id = id;
    }
    ...
    /// Collection relationship: ManyToMany
    /// </summary>
    public ICollection<BranchWarehouseTransferMaster> BranchWarehouseTransferMaster => _branchWarehouseTransferMaster;
    #endregion
