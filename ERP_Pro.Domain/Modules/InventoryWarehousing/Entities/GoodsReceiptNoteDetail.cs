...
public class GoodsReceiptNoteDetail : Entity<GoodsReceiptNoteDetailId>
{
    ...
    private readonly List<GoodsReceiptNoteMaster> _goodsReceiptNoteMaster = new List<GoodsReceiptNoteMaster>();

    private GoodsReceiptNoteDetail() { }

    public GoodsReceiptNoteDetail(GoodsReceiptNoteDetailId id)
    {
        Id = id;
    }
    ...
    /// Collection relationship: ManyToMany
    /// </summary>
    public ICollection<GoodsReceiptNoteMaster> GoodsReceiptNoteMaster => _goodsReceiptNoteMaster;
    #endregion
