...
public class ItemAlternative : Entity<ItemAlternativeId>
{
    ...
    public ItemAlternative(ItemAlternativeId id, string itemCode, string itemUnit, string itemCodeAlternative, string itemUnitAlternative)
    {
        Id = id;
        ItemCode = itemCode;
        ItemUnit = itemUnit;
        ItemCodeAlternative = itemCodeAlternative;
        ItemUnitAlternative = itemUnitAlternative;
    }
