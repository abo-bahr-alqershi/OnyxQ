...
public class BudgetBalanceColumnDetail : Entity<BudgetBalanceColumnDetailId>
{
    ...
    /// <summary>
    /// DocSer of the BudgetBalanceColumnDetail
    /// DocSer الخاص بـ BudgetBalanceColumnDetail
    /// </summary>
    public decimal? DocSer { get; private set; }

    /// <summary>
    /// AccountCode of the BudgetBalanceColumnDetail
    /// AccountCode الخاص بـ BudgetBalanceColumnDetail
    /// </summary>
    public string AccountCode { get; private set; }

    /// <summary>
    /// AccountCurrency of the BudgetBalanceColumnDetail
    /// AccountCurrency الخاص بـ BudgetBalanceColumnDetail
    /// </summary>
    public string AccountCurrency { get; private set; }

    /// <summary>
    /// CostCenterCode of the BudgetBalanceColumnDetail
    /// CostCenterCode الخاص بـ BudgetBalanceColumnDetail
    /// </summary>
    public string CostCenterCode { get; private set; }

    /// <summary>
    /// ProjectNumber of the BudgetBalanceColumnDetail
    /// ProjectNumber الخاص بـ BudgetBalanceColumnDetail
    /// </summary>
    public string ProjectNumber { get; private set; }

    /// <summary>
    /// ActivityNumber of the BudgetBalanceColumnDetail
    /// ActivityNumber الخاص بـ BudgetBalanceColumnDetail
    /// </summary>
