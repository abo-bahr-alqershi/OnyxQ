...
public class JournalVoucherMaster : Entity<JournalVoucherMasterId>
{
    ...
    /// <summary>
    /// JournalVoucherTypeFull of the JournalVoucherMaster
    /// JournalVoucherTypeFull الخاص بـ JournalVoucherMaster
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: JournalVoucherMaster to JournalVoucherDetail
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: JournalVoucherMaster to BranchJournalVoucherDetail
    /// </summary>
    public IReadOnlyCollection<BranchJournalVoucherDetail> BranchJournalVoucherDetails { get; private set; }
    #endregion
}
}
