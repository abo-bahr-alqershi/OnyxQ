...
public class HandCash : Entity<HandCashId>
{
    ...
    /// <summary>
    /// AccountCode of the HandCash
    /// AccountCode الخاص بـ HandCash
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: HandCash to CashInHandDetail
    /// </summary>
    public IReadOnlyCollection<CashInHandDetail> CashInHandDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: HandCash to CashManagementMaster
    /// </summary>
    public IReadOnlyCollection<CashManagementMaster> CashManagementMasters { get; private set; }
    /// <summary>
    /// One-to-many relationship: HandCash to AccountCurrency
    /// </summary>
