...
public class CostDetail : Entity<CostDetailId>
{
    ...
    /// <summary>
    /// GuarantorSerial of the CostDetail
    /// GuarantorSerial الخاص بـ CostDetail
    /// </summary>
    ...
    /// <summary>
    /// AccountCode of the CostDetail
    /// AccountCode الخاص بـ CostDetail
    /// </summary>
    ...
    /// <summary>
    /// AccountCurrency of the CostDetail
    /// AccountCurrency الخاص بـ CostDetail
    /// </summary>
    ...
    /// <summary>
    /// ManyToOne relationship to CostMaster
    /// </summary>
    public CostMaster CostMaster { get; private set; }
    #endregion
}
}
