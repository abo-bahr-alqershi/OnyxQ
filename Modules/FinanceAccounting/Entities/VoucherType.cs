...
public class VoucherType : Entity<VoucherTypeId>
{
    ...
    /// <summary>
    /// One-to-many relationship: VoucherType to GeneralLedgerVoucherTypeAccount
    /// </summary>
    public IReadOnlyCollection<GeneralLedgerVoucherTypeAccount> GeneralLedgerVoucherTypeAccounts { get; private set; }
    /// <summary>
    /// One-to-many relationship: VoucherType to GeneralLedgerVoucherTypePrivilege
    /// </summary>
    public IReadOnlyCollection<GeneralLedgerVoucherTypePrivilege> GeneralLedgerVoucherTypePrivileges { get; private set; }
    #endregion
}
}
