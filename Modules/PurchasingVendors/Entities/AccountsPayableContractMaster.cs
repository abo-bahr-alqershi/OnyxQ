...
/// </summary>
public class AccountsPayableContractMaster : Entity<AccountsPayableContractMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: AccountsPayableContractMaster to AccountsPayableContractBatch
    /// </summary>
    public IReadOnlyCollection<AccountsPayableContractBatch> AccountsPayableContractBatches { get; private set; }
    /// <summary>
    /// One-to-many relationship: AccountsPayableContractMaster to AccountsPayableContractDetail
    /// </summary>
    public IReadOnlyCollection<AccountsPayableContractDetail> AccountsPayableContractDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: AccountsPayableContractMaster to AccountsPayableContractRenew
    /// </summary>
    public IReadOnlyCollection<AccountsPayableContractRenew> AccountsPayableContractRenews { get; private set; }
    #endregion
}
}
