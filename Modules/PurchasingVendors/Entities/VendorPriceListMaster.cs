...
public class VendorPriceListMaster : Entity<VendorPriceListMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: VendorPriceListMaster to VendorPriceListDetail
    /// </summary>
    public IReadOnlyCollection<VendorPriceListDetail> VendorPriceListDetails { get; private set; }
    #endregion
}
}
