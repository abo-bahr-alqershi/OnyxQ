...
public class VendorQuotationDetail : Entity<VendorQuotationDetailId>
{
    ...
    /// <summary>
    /// QuotationSerial of the VendorQuotationDetail
    /// QuotationSerial الخاص بـ VendorQuotationDetail
    /// </summary>
    public decimal? QuotationSerial { get; private set; }

    /// <summary>
    /// ItemCode of the VendorQuotationDetail
    /// ItemCode الخاص بـ VendorQuotationDetail
    /// </summary>
    ...
    /// <summary>
    /// ItemUnit of the VendorQuotationDetail
    /// ItemUnit الخاص بـ VendorQuotationDetail
    /// </summary>
    ...
    /// <summary>
    /// ManyToOne relationship to VendorQuotationMaster
    /// </summary>
    public VendorQuotationMaster VendorQuotationMaster { get; private set; }
    #endregion
}
}
