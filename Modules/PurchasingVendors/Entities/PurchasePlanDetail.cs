...
public class PurchasePlanDetail : Entity<PurchasePlanDetailId>
{
    ...
    /// <summary>
    /// PlanSerial of the PurchasePlanDetail
    /// PlanSerial الخاص بـ PurchasePlanDetail
    /// </summary>
    ...
    /// <summary>
    /// PersonManagerCode of the PurchasePlanDetail
    /// PersonManagerCode الخاص بـ PurchasePlanDetail
    /// </summary>
    ...
    /// <summary>
    /// ManyToOne relationship to PurchasePlanMaster
    /// </summary>
    public PurchasePlanMaster PurchasePlanMaster { get; private set; }
    #endregion
}
}
