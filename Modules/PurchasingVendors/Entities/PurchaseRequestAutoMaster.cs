...
public class PurchaseRequestAutoMaster : Entity<PurchaseRequestAutoMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: PurchaseRequestAutoMaster to PurchaseRequestAutoDetail
    /// </summary>
    public IReadOnlyCollection<PurchaseRequestAutoDetail> PurchaseRequestAutoDetails { get; private set; }
    #endregion
}
}
