...
public class AccountsPayableCharge : Entity<AccountsPayableChargeId>
{
    ...
    /// <summary>
    /// AccountCode of the AccountsPayableCharge
    /// AccountCode الخاص بـ AccountsPayableCharge
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: AccountsPayableCharge to AccountsPayableChargeTdsSlice
    /// </summary>
    public IReadOnlyCollection<AccountsPayableChargeTdsSlice> AccountsPayableChargeTdsSlices { get; private set; }
    /// <summary>
    /// One-to-many relationship: AccountsPayableCharge to AccountsPayableOtherCharge
    /// </summary>
    public IReadOnlyCollection<AccountsPayableOtherCharge> AccountsPayableOtherCharges { get; private set; }
    /// <summary>
    /// One-to-many relationship: AccountsPayableCharge to AccountsPayableOtherChargeItem
    /// </summary>
