...
public class PurchaseOrderDetail : Entity<PurchaseOrderDetailId>
{
    ...
    /// <summary>
    /// PurchaseOrderSerial of the PurchaseOrderDetail
    /// PurchaseOrderSerial الخاص بـ PurchaseOrderDetail
    /// </summary>
    public decimal? PurchaseOrderSerial { get; private set; }

    /// <summary>
    /// ItemCode of the PurchaseOrderDetail
    /// ItemCode الخاص بـ PurchaseOrderDetail
    /// </summary>
    ...
    /// <summary>
    /// ItemUnit of the PurchaseOrderDetail
    /// ItemUnit الخاص بـ PurchaseOrderDetail
    /// </summary>
    ...
    /// <summary>
    /// WarehouseCode of the PurchaseOrderDetail
    /// WarehouseCode الخاص بـ PurchaseOrderDetail
    /// </summary>
    ...
    /// <summary>
    /// ManyToOne relationship to PurchaseOrder
    /// </summary>
