...
public class PurchaseRequestDetail : Entity<PurchaseRequestDetailId>
{
    ...
    /// <summary>
    /// PriceSerial of the PurchaseRequestDetail
    /// PriceSerial الخاص بـ PurchaseRequestDetail
    /// </summary>
    public decimal? PriceSerial { get; private set; }

    /// <summary>
    /// ItemCode of the PurchaseRequestDetail
    /// ItemCode الخاص بـ PurchaseRequestDetail
    /// </summary>
    ...
    /// <summary>
    /// ItemUnit of the PurchaseRequestDetail
    /// ItemUnit الخاص بـ PurchaseRequestDetail
    /// </summary>
    ...
    /// <summary>
    /// ManyToOne relationship to PurchaseRequest
    /// </summary>
