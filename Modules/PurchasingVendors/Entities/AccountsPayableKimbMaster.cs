...
public class AccountsPayableKimbMaster : Entity<AccountsPayableKimbMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: AccountsPayableKimbMaster to AccountsPayableKimbDetail
    /// </summary>
    public IReadOnlyCollection<AccountsPayableKimbDetail> AccountsPayableKimbDetails { get; private set; }
    #endregion
}
}
