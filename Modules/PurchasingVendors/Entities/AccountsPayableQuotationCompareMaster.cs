...
public class AccountsPayableQuotationCompareMaster : Entity<AccountsPayableQuotationCompareMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: AccountsPayableQuotationCompareMaster to AccountsPayableQuotationCompareDetail
    /// </summary>
    public IReadOnlyCollection<AccountsPayableQuotationCompareDetail> AccountsPayableQuotationCompareDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: AccountsPayableQuotationCompareMaster to AccountsPayableQuotationCompareMember
    /// </summary>
    public IReadOnlyCollection<AccountsPayableQuotationCompareMember> AccountsPayableQuotationCompareMembers { get; private set; }
    #endregion
}
}
