...
public class QuotationDetail : Entity<QuotationDetailId>
{
    ...
    /// <summary>
    /// QuotationSerialFull of the QuotationDetail
    /// QuotationSerialFull الخاص بـ QuotationDetail
    /// </summary>
    public decimal? QuotationSerialFull { get; private set; }

    /// <summary>
    /// ItemCode of the QuotationDetail
    /// ItemCode الخاص بـ QuotationDetail
    /// </summary>
    ...
    /// <summary>
    /// ItemUnit of the QuotationDetail
    /// ItemUnit الخاص بـ QuotationDetail
    /// </summary>
    ...
    /// <summary>
    /// ManyToOne relationship to Quotation
    /// </summary>
