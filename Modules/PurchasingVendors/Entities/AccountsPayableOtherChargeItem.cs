...
public class AccountsPayableOtherChargeItem : Entity<AccountsPayableOtherChargeItemId>
{
    ...
    /// <summary>
    /// ChargeNumber of the AccountsPayableOtherChargeItem
    /// ChargeNumber الخاص بـ AccountsPayableOtherChargeItem
    /// </summary>
    public decimal? ChargeNumber { get; private set; }

    /// <summary>
    /// AccountCode of the AccountsPayableOtherChargeItem
    /// AccountCode الخاص بـ AccountsPayableOtherChargeItem
    /// </summary>
    ...
    /// <summary>
    /// AccountCurrency of the AccountsPayableOtherChargeItem
    /// AccountCurrency الخاص بـ AccountsPayableOtherChargeItem
    /// </summary>
    ...
    /// <summary>
    /// ProjectNumber of the AccountsPayableOtherChargeItem
    /// ProjectNumber الخاص بـ AccountsPayableOtherChargeItem
    /// </summary>
    public string ProjectNumber { get; private set; }

    /// <summary>
    /// ActivityNumber of the AccountsPayableOtherChargeItem
    /// ActivityNumber الخاص بـ AccountsPayableOtherChargeItem
    /// </summary>
    ...
    /// <summary>
    /// ItemCode of the AccountsPayableOtherChargeItem
    /// ItemCode الخاص بـ AccountsPayableOtherChargeItem
    /// </summary>
    ...
    /// <summary>
    /// ManyToOne relationship to AccountsPayableCharge
    /// </summary>
