...
public class CheckDocumentInOutQuantityMaster : Entity<CheckDocumentInOutQuantityMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: CheckDocumentInOutQuantityMaster to CheckDocumentInOutQuantityDetail
    /// </summary>
    public IReadOnlyCollection<CheckDocumentInOutQuantityDetail> CheckDocumentInOutQuantityDetails { get; private set; }
    #endregion
}
}
