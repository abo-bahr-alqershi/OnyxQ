...
public class ItemMaster : Entity<ItemMasterId>
{
    ...
    /// <summary>
    /// GuarantorCode of the ItemMaster
    /// GuarantorCode الخاص بـ ItemMaster
    /// </summary>
    public string GuarantorCode { get; private set; }

    /// <summary>
    /// GroupClassCode of the ItemMaster
    /// GroupClassCode الخاص بـ ItemMaster
    /// </summary>
    ...
    /// <summary>
    /// ItemType of the ItemMaster
    /// ItemType الخاص بـ ItemMaster
    /// </summary>
    ...
    /// <summary>
    /// GroupNumber of the ItemMaster
    /// GroupNumber الخاص بـ ItemMaster
    /// </summary>
    public decimal? GroupNumber { get; private set; }

    /// <summary>
    /// ItemLevelNumber of the ItemMaster
    /// ItemLevelNumber الخاص بـ ItemMaster
    /// </summary>
    ...
    /// <summary>
    /// AssistantNumber of the ItemMaster
    /// AssistantNumber الخاص بـ ItemMaster
    /// </summary>
    public string AssistantNumber { get; private set; }

    /// <summary>
    /// DetailNo of the ItemMaster
    /// DetailNo الخاص بـ ItemMaster
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: ItemMaster to ActivitySerialNumberDetail
    /// </summary>
    public IReadOnlyCollection<ActivitySerialNumberDetail> ActivitySerialNumberDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to CustomerCommissionCalculationDetail
    /// </summary>
    public IReadOnlyCollection<CustomerCommissionCalculationDetail> CustomerCommissionCalculationDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to CustomerCommissionSetupDetail
    /// </summary>
    public IReadOnlyCollection<CustomerCommissionSetupDetail> CustomerCommissionSetupDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to SalesmanCommissionCalculationDetail
    /// </summary>
    public IReadOnlyCollection<SalesmanCommissionCalculationDetail> SalesmanCommissionCalculationDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to SalesmanCommissionSetupDetail
    /// </summary>
    public IReadOnlyCollection<SalesmanCommissionSetupDetail> SalesmanCommissionSetupDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to PromotionCommissionCalculationDetail
    /// </summary>
    public IReadOnlyCollection<PromotionCommissionCalculationDetail> PromotionCommissionCalculationDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to PromotionCommissionSetupDetail
    /// </summary>
    public IReadOnlyCollection<PromotionCommissionSetupDetail> PromotionCommissionSetupDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to PromotionItem
    /// </summary>
    public IReadOnlyCollection<PromotionItem> PromotionItems { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to BillDetailAdditionalDiscountRequest
    /// </summary>
    public IReadOnlyCollection<BillDetailAdditionalDiscountRequest> BillDetailAdditionalDiscountRequests { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to BranchBillDetail
    /// </summary>
    public IReadOnlyCollection<BranchBillDetail> BranchBillDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to EmployeeCommissionCalculationDetail
    /// </summary>
    public IReadOnlyCollection<EmployeeCommissionCalculationDetail> EmployeeCommissionCalculationDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to EmployeeCommissionSetupDetail
    /// </summary>
    public IReadOnlyCollection<EmployeeCommissionSetupDetail> EmployeeCommissionSetupDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to ReturnBillDetail
    /// </summary>
    public IReadOnlyCollection<ReturnBillDetail> ReturnBillDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to BranchReturnBillDetail
    /// </summary>
    public IReadOnlyCollection<BranchReturnBillDetail> BranchReturnBillDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to ReturnBillDetailRequest
    /// </summary>
    public IReadOnlyCollection<ReturnBillDetailRequest> ReturnBillDetailRequests { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to AutoSalesOrderDetail
    /// </summary>
    public IReadOnlyCollection<AutoSalesOrderDetail> AutoSalesOrderDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to AccountsPayableOtherChargeItem
    /// </summary>
    public IReadOnlyCollection<AccountsPayableOtherChargeItem> AccountsPayableOtherChargeItems { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to QuotationPromotionGroupDetail
    /// </summary>
    public IReadOnlyCollection<QuotationPromotionGroupDetail> QuotationPromotionGroupDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to ItemBin
    /// </summary>
    public IReadOnlyCollection<ItemBin> ItemBins { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to InventoryMachineDetail
    /// </summary>
    public IReadOnlyCollection<InventoryMachineDetail> InventoryMachineDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to InventoryMachineSubDetail
    /// </summary>
    public IReadOnlyCollection<InventoryMachineSubDetail> InventoryMachineSubDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to BranchItemSerialNumber
    /// </summary>
    public IReadOnlyCollection<BranchItemSerialNumber> BranchItemSerialNumbers { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to GoodsReceiptNoteItemSerialNumber
    /// </summary>
    public IReadOnlyCollection<GoodsReceiptNoteItemSerialNumber> GoodsReceiptNoteItemSerialNumbers { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to OtherItemSerialNumber
    /// </summary>
    public IReadOnlyCollection<OtherItemSerialNumber> OtherItemSerialNumbers { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to ItemAttachmentMovement
    /// </summary>
    public IReadOnlyCollection<ItemAttachmentMovement> ItemAttachmentMovements { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to OtherItemAttachment
    /// </summary>
    public IReadOnlyCollection<OtherItemAttachment> OtherItemAttachments { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to ItemDetail
    /// </summary>
    public IReadOnlyCollection<ItemDetail> ItemDetails { get; private set; }
    /// <summary>
    /// ManyToOne relationship to GroupItemLevel
    /// </summary>
    public GroupItemLevel GroupItemLevel { get; private set; }
    /// <summary>
    /// ManyToOne relationship to ItemLevel
    /// </summary>
    public ItemLevel ItemLevel { get; private set; }
    /// <summary>
    /// ManyToOne relationship to DetailGroup
    /// </summary>
    ...
    /// <summary>
    /// ManyToOne relationship to AlternativeGroup
    /// </summary>
    public AlternativeGroup AlternativeGroup { get; private set; }
    /// <summary>
    /// ManyToOne relationship to AssistantGroup
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: ItemMaster to ItemQuantityLimit
    /// </summary>
    public IReadOnlyCollection<ItemQuantityLimit> ItemQuantityLimits { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to ItemSalesman
    /// </summary>
    public IReadOnlyCollection<ItemSalesman> ItemSalesmans { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to ItemWarehouseCode
    /// </summary>
    public IReadOnlyCollection<ItemWarehouseCode> ItemWarehouseCodes { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to MeasureDiscountItemTransaction
    /// </summary>
    public IReadOnlyCollection<MeasureDiscountItemTransaction> MeasureDiscountItemTransactions { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to PerformaInvoiceBillDetailAdditionalDiscount
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: ItemMaster to ScaleMovement
    /// </summary>
    public IReadOnlyCollection<ScaleMovement> ScaleMovements { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to InventoryItemBinMovement
    /// </summary>
    public IReadOnlyCollection<InventoryItemBinMovement> InventoryItemBinMovements { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to KitItem
    /// </summary>
    public IReadOnlyCollection<KitItem> KitItems { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to InsuranceCardChronic
    /// </summary>
    public IReadOnlyCollection<InsuranceCardChronic> InsuranceCardChronics { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to FreightDetail
    /// </summary>
    public IReadOnlyCollection<FreightDetail> FreightDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to ReceiptDocument
    /// </summary>
    public IReadOnlyCollection<ReceiptDocument> ReceiptDocuments { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to QuestionnaireDetail
    /// </summary>
    public IReadOnlyCollection<QuestionnaireDetail> QuestionnaireDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to QuestionnaireSubDetail
    /// </summary>
    public IReadOnlyCollection<QuestionnaireSubDetail> QuestionnaireSubDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: ItemMaster to RequestCompensationQuantityCalculationDetail
    /// </summary>
