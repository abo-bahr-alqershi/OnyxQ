...
public class WarehouseTransferMultiDetail : Entity<WarehouseTransferMultiDetailId>
{
    ...
    /// <summary>
    /// TransactionSerial of the WarehouseTransferMultiDetail
    /// TransactionSerial الخاص بـ WarehouseTransferMultiDetail
    /// </summary>
    public decimal? TransactionSerial { get; private set; }

    /// <summary>
    /// ItemCode of the WarehouseTransferMultiDetail
    /// ItemCode الخاص بـ WarehouseTransferMultiDetail
    /// </summary>
    ...
    /// <summary>
    /// ItemUnit of the WarehouseTransferMultiDetail
    /// ItemUnit الخاص بـ WarehouseTransferMultiDetail
    /// </summary>
    ...
    /// <summary>
    /// TWarehouseCode of the WarehouseTransferMultiDetail
    /// TWarehouseCode الخاص بـ WarehouseTransferMultiDetail
    /// </summary>
    public decimal? TWarehouseCode { get; private set; }

    /// <summary>
    /// FWarehouseCode of the WarehouseTransferMultiDetail
    /// FWarehouseCode الخاص بـ WarehouseTransferMultiDetail
    /// </summary>
    ...
    /// <summary>
    /// ProjectNumber of the WarehouseTransferMultiDetail
    /// ProjectNumber الخاص بـ WarehouseTransferMultiDetail
    /// </summary>
    public string ProjectNumber { get; private set; }

    /// <summary>
    /// ActivityNumber of the WarehouseTransferMultiDetail
    /// ActivityNumber الخاص بـ WarehouseTransferMultiDetail
    /// </summary>
    ...
    /// <summary>
    /// VendorCode of the WarehouseTransferMultiDetail
    /// VendorCode الخاص بـ WarehouseTransferMultiDetail
    /// </summary>
    ...
    /// <summary>
    /// ManyToOne relationship to WarehouseTransferMultiMaster
    /// </summary>
    public WarehouseTransferMultiMaster WarehouseTransferMultiMaster { get; private set; }
    #endregion
}
}
