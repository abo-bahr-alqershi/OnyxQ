...
public class InventoryRequestAssemblyMaster : Entity<InventoryRequestAssemblyMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: InventoryRequestAssemblyMaster to InventoryRequestAssemblyDetail
    /// </summary>
    public IReadOnlyCollection<InventoryRequestAssemblyDetail> InventoryRequestAssemblyDetails { get; private set; }
    #endregion
}
}
