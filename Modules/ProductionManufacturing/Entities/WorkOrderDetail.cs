...
public class WorkOrderDetail : Entity<WorkOrderDetailId>
{
    ...
    /// <summary>
    /// WorkOrderSerial of the WorkOrderDetail
    /// WorkOrderSerial الخاص بـ WorkOrderDetail
    /// </summary>
    ...
    /// <summary>
    /// ItemCode of the WorkOrderDetail
    /// ItemCode الخاص بـ WorkOrderDetail
    /// </summary>
    ...
    /// <summary>
    /// ItemUnit of the WorkOrderDetail
    /// ItemUnit الخاص بـ WorkOrderDetail
    /// </summary>
    ...
    /// <summary>
    /// ManyToOne relationship to WorkOrderMaster
    /// </summary>
    public WorkOrderMaster WorkOrderMaster { get; private set; }
    #endregion
}
}
