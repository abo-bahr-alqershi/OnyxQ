...
public class InsuranceCompany : Entity<InsuranceCompanyId>
{
    ...
    /// <summary>
    /// One-to-many relationship: InsuranceCompany to InsuranceCompanyClass
    /// </summary>
    public IReadOnlyCollection<InsuranceCompanyClass> InsuranceCompanyClasses { get; private set; }
    /// <summary>
    /// One-to-many relationship: InsuranceCompany to InsuranceContractCondition
    /// </summary>
    public IReadOnlyCollection<InsuranceContractCondition> InsuranceContractConditions { get; private set; }
    /// <summary>
    /// One-to-many relationship: InsuranceCompany to InsuranceContractConditionBill
    /// </summary>
