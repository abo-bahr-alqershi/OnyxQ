...
public class InsuranceClassMedicalNetwork : Entity<InsuranceClassMedicalNetworkId>
{
    ...
    /// <summary>
    /// InsuranceCompanyNumberAlt of the InsuranceClassMedicalNetwork
    /// InsuranceCompanyNumberAlt الخاص بـ InsuranceClassMedicalNetwork
    /// </summary>
    public decimal? InsuranceCompanyNumberAlt { get; private set; }

    /// <summary>
    /// ClassNumber of the InsuranceClassMedicalNetwork
    /// ClassNumber الخاص بـ InsuranceClassMedicalNetwork
    /// </summary>
