...
public class InsuranceClaimMaster : Entity<InsuranceClaimMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: InsuranceClaimMaster to InsuranceClaimDetail
    /// </summary>
    public IReadOnlyCollection<InsuranceClaimDetail> InsuranceClaimDetails { get; private set; }
    #endregion
}
}
