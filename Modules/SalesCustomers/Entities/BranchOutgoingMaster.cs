...
public class BranchOutgoingMaster : Entity<BranchOutgoingMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: BranchOutgoingMaster to BranchOutgoingDetail
    /// </summary>
    public IReadOnlyCollection<BranchOutgoingDetail> BranchOutgoingDetails { get; private set; }
    #endregion
}
}
