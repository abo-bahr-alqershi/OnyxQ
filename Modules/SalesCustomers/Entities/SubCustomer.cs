...
public class SubCustomer : Entity<SubCustomerId>
{
    ...
    /// <summary>
    /// One-to-many relationship: SubCustomer to SubCustomerMeasureMaster
    /// </summary>
    public IReadOnlyCollection<SubCustomerMeasureMaster> SubCustomerMeasureMasters { get; private set; }
    #endregion
}
}
