...
public class BranchOutgoingBillMaster : Entity<BranchOutgoingBillMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: BranchOutgoingBillMaster to BranchOutgoingBillDetail
    /// </summary>
    public IReadOnlyCollection<BranchOutgoingBillDetail> BranchOutgoingBillDetails { get; private set; }
    #endregion
}
}
