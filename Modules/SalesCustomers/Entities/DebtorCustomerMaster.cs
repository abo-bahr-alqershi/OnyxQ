...
public class DebtorCustomerMaster : Entity<DebtorCustomerMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: DebtorCustomerMaster to DebtorCustomerDetail
    /// </summary>
    public IReadOnlyCollection<DebtorCustomerDetail> DebtorCustomerDetails { get; private set; }
    #endregion
}
}
