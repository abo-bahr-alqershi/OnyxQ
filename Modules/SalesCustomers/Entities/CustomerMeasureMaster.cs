...
public class CustomerMeasureMaster : Entity<CustomerMeasureMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: CustomerMeasureMaster to CustomerMeasureDetail
    /// </summary>
    public IReadOnlyCollection<CustomerMeasureDetail> CustomerMeasureDetails { get; private set; }
    #endregion
}
}
