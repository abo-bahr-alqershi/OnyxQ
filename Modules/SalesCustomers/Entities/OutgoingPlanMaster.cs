...
/// </summary>
public class OutgoingPlanMaster : Entity<OutgoingPlanMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: OutgoingPlanMaster to OutgoingPlanDetail
    /// </summary>
    public IReadOnlyCollection<OutgoingPlanDetail> OutgoingPlanDetails { get; private set; }
    #endregion
}
}
