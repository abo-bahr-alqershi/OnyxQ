...
public class Customer : Entity<CustomerId>
{
    ...
    /// <summary>
    /// CACode of the Customer
    /// CACode الخاص بـ Customer
    /// </summary>
    ...
    /// <summary>
    /// CGroupCode of the Customer
    /// CGroupCode الخاص بـ Customer
    /// </summary>
    ...
    /// <summary>
    /// CountryNumber of the Customer
    /// CountryNumber الخاص بـ Customer
    /// </summary>
    ...
    /// <summary>
    /// CityNumber of the Customer
    /// CityNumber الخاص بـ Customer
    /// </summary>
    public decimal? CityNumber { get; private set; }

    /// <summary>
    /// RegionCode of the Customer
    /// RegionCode الخاص بـ Customer
    /// </summary>
    public decimal? RegionCode { get; private set; }

    /// <summary>
    /// RepCode of the Customer
    /// RepCode الخاص بـ Customer
    /// </summary>
    ...
    /// <summary>
    /// ColumnNumberShort of the Customer
    /// ColumnNumberShort الخاص بـ Customer
    /// </summary>
    public decimal? ColumnNumberShort { get; private set; }

    /// <summary>
    /// CostCenterCode of the Customer
    /// CostCenterCode الخاص بـ Customer
    /// </summary>
    ...
    /// <summary>
    /// CClass of the Customer
    /// CClass الخاص بـ Customer
    /// </summary>
    public decimal? CClass { get; private set; }

    /// <summary>
    /// CDegree of the Customer
    /// CDegree الخاص بـ Customer
    /// </summary>
    ...
    /// <summary>
    /// CClassTyp of the Customer
    /// CClassTyp الخاص بـ Customer
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: Customer to ScreenCssPrivilege
    /// </summary>
    public IReadOnlyCollection<ScreenCssPrivilege> ScreenCssPrivileges { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to CustomerHandheldDevice
    /// </summary>
    public IReadOnlyCollection<CustomerHandheldDevice> CustomerHandheldDevices { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to JournalFileDetail
    /// </summary>
    public IReadOnlyCollection<JournalFileDetail> JournalFileDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to ApprovalAppDevice
    /// </summary>
    public IReadOnlyCollection<ApprovalAppDevice> ApprovalAppDevices { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to JournalVoucherDetail
    /// </summary>
    public IReadOnlyCollection<JournalVoucherDetail> JournalVoucherDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to VoucherDetail
    /// </summary>
    public IReadOnlyCollection<VoucherDetail> VoucherDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to VoucherChequeDetail
    /// </summary>
    public IReadOnlyCollection<VoucherChequeDetail> VoucherChequeDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to CustomerAccount
    /// </summary>
    ...
    /// <summary>
    /// ManyToOne relationship to CustomerClassType
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: Customer to CustomerBankAccount
    /// </summary>
    public IReadOnlyCollection<CustomerBankAccount> CustomerBankAccounts { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to CustomerCurrency
    /// </summary>
    public IReadOnlyCollection<CustomerCurrency> CustomerCurrencies { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to SalesOrder
    /// </summary>
    public IReadOnlyCollection<SalesOrder> SalesOrders { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to SalesChargeItem
    /// </summary>
    public IReadOnlyCollection<SalesChargeItem> SalesChargeItems { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to SalesDiscount
    /// </summary>
    public IReadOnlyCollection<SalesDiscount> SalesDiscounts { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to SalesFreeQuantity
    /// </summary>
    public IReadOnlyCollection<SalesFreeQuantity> SalesFreeQuantities { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to CustomerCommissionCalculationDetail
    /// </summary>
    public IReadOnlyCollection<CustomerCommissionCalculationDetail> CustomerCommissionCalculationDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to CustomerCommissionSetupDetail
    /// </summary>
    public IReadOnlyCollection<CustomerCommissionSetupDetail> CustomerCommissionSetupDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to CustomerDevices
    /// </summary>
    public IReadOnlyCollection<CustomerDevices> CustomerDeviceses { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to CustomerItemActivity
    /// </summary>
    public IReadOnlyCollection<CustomerItemActivity> CustomerItemActivities { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to CustomerItemLimitSale
    /// </summary>
    public IReadOnlyCollection<CustomerItemLimitSale> CustomerItemLimitSales { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to CustomerLocation
    /// </summary>
    public IReadOnlyCollection<CustomerLocation> CustomerLocations { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to CustomerCostCenterLimit
    /// </summary>
    public IReadOnlyCollection<CustomerCostCenterLimit> CustomerCostCenterLimits { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to CustomerCostCenterLimitRequest
    /// </summary>
    public IReadOnlyCollection<CustomerCostCenterLimitRequest> CustomerCostCenterLimitRequests { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to CustomerSigns
    /// </summary>
    public IReadOnlyCollection<CustomerSigns> CustomerSignses { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to SalesPlanDetail
    /// </summary>
    public IReadOnlyCollection<SalesPlanDetail> SalesPlanDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to PromotionCustomer
    /// </summary>
    public IReadOnlyCollection<PromotionCustomer> PromotionCustomers { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to BillMaster
    /// </summary>
    public IReadOnlyCollection<BillMaster> BillMasters { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to BillMasterAdditionalDiscount
    /// </summary>
    public IReadOnlyCollection<BillMasterAdditionalDiscount> BillMasterAdditionalDiscounts { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to BillMasterAdditionalDiscountRequest
    /// </summary>
    public IReadOnlyCollection<BillMasterAdditionalDiscountRequest> BillMasterAdditionalDiscountRequests { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to CollectionPlan
    /// </summary>
    public IReadOnlyCollection<CollectionPlan> CollectionPlans { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to ReturnBillMaster
    /// </summary>
    public IReadOnlyCollection<ReturnBillMaster> ReturnBillMasters { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to ReturnBillMasterRequest
    /// </summary>
    public IReadOnlyCollection<ReturnBillMasterRequest> ReturnBillMasterRequests { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to AutoSalesOrderMaster
    /// </summary>
    public IReadOnlyCollection<AutoSalesOrderMaster> AutoSalesOrderMasters { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to Quotation
    /// </summary>
    public IReadOnlyCollection<Quotation> Quotations { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to PurchaseBillMaster
    /// </summary>
    public IReadOnlyCollection<PurchaseBillMaster> PurchaseBillMasters { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to AdjustInstallmentMaster
    /// </summary>
    public IReadOnlyCollection<AdjustInstallmentMaster> AdjustInstallmentMasters { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to GoodsReceiptNote
    /// </summary>
    public IReadOnlyCollection<GoodsReceiptNote> GoodsReceiptNotes { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to IncomingOutgoingMaster
    /// </summary>
    public IReadOnlyCollection<IncomingOutgoingMaster> IncomingOutgoingMasters { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to StationBillCredit
    /// </summary>
    public IReadOnlyCollection<StationBillCredit> StationBillCredits { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to StationCreditBillDetail
    /// </summary>
    public IReadOnlyCollection<StationCreditBillDetail> StationCreditBillDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to StationCreditBillMaster
    /// </summary>
    public IReadOnlyCollection<StationCreditBillMaster> StationCreditBillMasters { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to Note
    /// </summary>
    public IReadOnlyCollection<Note> Notes { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to ReceiptDocument
    /// </summary>
    public IReadOnlyCollection<ReceiptDocument> ReceiptDocuments { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to QuestionnaireMaster
    /// </summary>
    public IReadOnlyCollection<QuestionnaireMaster> QuestionnaireMasters { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to PricingLevel
    /// </summary>
    public IReadOnlyCollection<PricingLevel> PricingLevels { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to ExchangeRate
    /// </summary>
    public IReadOnlyCollection<ExchangeRate> ExchangeRates { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to ItemDetail
    /// </summary>
    public IReadOnlyCollection<ItemDetail> ItemDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to SalesCharge
    /// </summary>
    public IReadOnlyCollection<SalesCharge> SalesCharges { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to GroupDetail
    /// </summary>
    public IReadOnlyCollection<GroupDetail> GroupDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to CustomerClass
    /// </summary>
    public IReadOnlyCollection<CustomerClass> CustomerClasses { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to Warehouse
    /// </summary>
    public IReadOnlyCollection<Warehouse> Warehouses { get; private set; }
    /// <summary>
    /// One-to-many relationship: Customer to WarehouseGroup
    /// </summary>
