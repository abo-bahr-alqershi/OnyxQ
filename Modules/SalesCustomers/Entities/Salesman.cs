...
public class Salesman : Entity<SalesmanId>
{
    ...
    /// <summary>
    /// RegionAccountCode of the Salesman
    /// RegionAccountCode الخاص بـ Salesman
    /// </summary>
    public string RegionAccountCode { get; private set; }

    /// <summary>
    /// SalesmanType of the Salesman
    /// SalesmanType الخاص بـ Salesman
    /// </summary>
    public decimal? SalesmanType { get; private set; }

    /// <summary>
    /// CountryNumber of the Salesman
    /// CountryNumber الخاص بـ Salesman
    /// </summary>
    public decimal? CountryNumber { get; private set; }

    /// <summary>
    /// CityNumber of the Salesman
    /// CityNumber الخاص بـ Salesman
    /// </summary>
    public decimal? CityNumber { get; private set; }

    /// <summary>
    /// RegionCode of the Salesman
    /// RegionCode الخاص بـ Salesman
    /// </summary>
    ...
    /// <summary>
    /// RepCodeParent of the Salesman
    /// RepCodeParent الخاص بـ Salesman
    /// </summary>
    ...
    /// <summary>
    /// CostCenterCode of the Salesman
    /// CostCenterCode الخاص بـ Salesman
    /// </summary>
    public string CostCenterCode { get; private set; }

    /// <summary>
    /// ProjectNumber of the Salesman
    /// ProjectNumber الخاص بـ Salesman
    /// </summary>
    public string ProjectNumber { get; private set; }

    /// <summary>
    /// ActivityNumber of the Salesman
    /// ActivityNumber الخاص بـ Salesman
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: Salesman to GeneralLedgerRequestVoucherMasterAccount
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: Salesman to Salesman
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: Salesman to SalesOrder
    /// </summary>
    public IReadOnlyCollection<SalesOrder> SalesOrders { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to CustomerSalesman
    /// </summary>
    public IReadOnlyCollection<CustomerSalesman> CustomerSalesmans { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to SalesPlanDetail
    /// </summary>
    public IReadOnlyCollection<SalesPlanDetail> SalesPlanDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to SalesmanCollectionConditionDetail
    /// </summary>
    public IReadOnlyCollection<SalesmanCollectionConditionDetail> SalesmanCollectionConditionDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to SalesmanCommissionDetail
    /// </summary>
    public IReadOnlyCollection<SalesmanCommissionDetail> SalesmanCommissionDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to SalesmanDocumentSyncDetails
    /// </summary>
    public IReadOnlyCollection<SalesmanDocumentSyncDetails> SalesmanDocumentSyncDetailses { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to SalesmanItemActivity
    /// </summary>
    public IReadOnlyCollection<SalesmanItemActivity> SalesmanItemActivities { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to BillMaster
    /// </summary>
    public IReadOnlyCollection<BillMaster> BillMasters { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to BranchBillMaster
    /// </summary>
    public IReadOnlyCollection<BranchBillMaster> BranchBillMasters { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to BillCoupon
    /// </summary>
    public IReadOnlyCollection<BillCoupon> BillCoupons { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to ReturnBillMaster
    /// </summary>
    public IReadOnlyCollection<ReturnBillMaster> ReturnBillMasters { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to BranchReturnBillMaster
    /// </summary>
    public IReadOnlyCollection<BranchReturnBillMaster> BranchReturnBillMasters { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to ReturnBillMasterRequest
    /// </summary>
    public IReadOnlyCollection<ReturnBillMasterRequest> ReturnBillMasterRequests { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to RegionSalesman
    /// </summary>
    public IReadOnlyCollection<RegionSalesman> RegionSalesmans { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to Quotation
    /// </summary>
    public IReadOnlyCollection<Quotation> Quotations { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to ItemSalesman
    /// </summary>
    public IReadOnlyCollection<ItemSalesman> ItemSalesmans { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to GuaranteeDetail
    /// </summary>
    public IReadOnlyCollection<GuaranteeDetail> GuaranteeDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to Promoter
    /// </summary>
    public IReadOnlyCollection<Promoter> Promoters { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to QuestionnaireMaster
    /// </summary>
    public IReadOnlyCollection<QuestionnaireMaster> QuestionnaireMasters { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to RequestJournalDetail
    /// </summary>
    public IReadOnlyCollection<RequestJournalDetail> RequestJournalDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to ItemActivity
    /// </summary>
    public IReadOnlyCollection<ItemActivity> ItemActivities { get; private set; }
    /// <summary>
    /// One-to-many relationship: Salesman to Region
    /// </summary>
