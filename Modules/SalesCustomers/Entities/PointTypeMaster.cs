...
public class PointTypeMaster : Entity<PointTypeMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: PointTypeMaster to PointTypeCalculationDetail
    /// </summary>
    public IReadOnlyCollection<PointTypeCalculationDetail> PointTypeCalculationDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: PointTypeMaster to PointTypeReplacementDetail
    /// </summary>
    public IReadOnlyCollection<PointTypeReplacementDetail> PointTypeReplacementDetails { get; private set; }
    #endregion
}
}
