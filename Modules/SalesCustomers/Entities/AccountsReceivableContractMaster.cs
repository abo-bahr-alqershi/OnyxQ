...
public class AccountsReceivableContractMaster : Entity<AccountsReceivableContractMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: AccountsReceivableContractMaster to AccountsReceivableContractBatch
    /// </summary>
    public IReadOnlyCollection<AccountsReceivableContractBatch> AccountsReceivableContractBatches { get; private set; }
    /// <summary>
    /// One-to-many relationship: AccountsReceivableContractMaster to AccountsReceivableContractDetail
    /// </summary>
    public IReadOnlyCollection<AccountsReceivableContractDetail> AccountsReceivableContractDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: AccountsReceivableContractMaster to AccountsReceivableContractRenew
    /// </summary>
    public IReadOnlyCollection<AccountsReceivableContractRenew> AccountsReceivableContractRenews { get; private set; }
    #endregion
}
}
