...
/// </summary>
public class SalesmanCommissionCalculationMaster : Entity<SalesmanCommissionCalculationMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: SalesmanCommissionCalculationMaster to SalesmanCommissionCalculationDetail
    /// </summary>
    public IReadOnlyCollection<SalesmanCommissionCalculationDetail> SalesmanCommissionCalculationDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: SalesmanCommissionCalculationMaster to SalesmanCommissionCalculationSubDetail
    /// </summary>
    public IReadOnlyCollection<SalesmanCommissionCalculationSubDetail> SalesmanCommissionCalculationSubDetails { get; private set; }
    #endregion
}
}
