...
public class EmployeeCommissionCalculationDetail : Entity<EmployeeCommissionCalculationDetailId>
{
    ...
    /// <summary>
    /// DocSrl of the EmployeeCommissionCalculationDetail
    /// DocSrl الخاص بـ EmployeeCommissionCalculationDetail
    /// </summary>
    ...
    /// <summary>
    /// ItemCode of the EmployeeCommissionCalculationDetail
    /// ItemCode الخاص بـ EmployeeCommissionCalculationDetail
    /// </summary>
    ...
    /// <summary>
    /// ManyToOne relationship to EmployeeCommissionCalculationMaster
    /// </summary>
    public EmployeeCommissionCalculationMaster EmployeeCommissionCalculationMaster { get; private set; }
    #endregion
}
}
