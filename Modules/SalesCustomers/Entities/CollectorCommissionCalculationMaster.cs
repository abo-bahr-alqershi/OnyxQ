...
/// </summary>
public class CollectorCommissionCalculationMaster : Entity<CollectorCommissionCalculationMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: CollectorCommissionCalculationMaster to CollectorCommissionCalculationDetail
    /// </summary>
    public IReadOnlyCollection<CollectorCommissionCalculationDetail> CollectorCommissionCalculationDetails { get; private set; }
    #endregion
}
}
