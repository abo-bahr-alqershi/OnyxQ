...
public class CouponMaster : Entity<CouponMasterId>
{
    ...
    /// <summary>
    /// CouponTypeNumber of the CouponMaster
    /// CouponTypeNumber الخاص بـ CouponMaster
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: CouponMaster to CouponDetail
    /// </summary>
    public IReadOnlyCollection<CouponDetail> CouponDetails { get; private set; }
    /// <summary>
