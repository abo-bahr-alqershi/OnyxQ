...
public class CustomerItemLimitSale : Entity<CustomerItemLimitSaleId>
{
    ...
    /// <summary>
    /// CCode of the CustomerItemLimitSale
    /// CCode الخاص بـ CustomerItemLimitSale
    /// </summary>
    public string CCode { get; private set; }

    /// <summary>
    /// ItemCode of the CustomerItemLimitSale
    /// ItemCode الخاص بـ CustomerItemLimitSale
    /// </summary>
    public string ItemCode { get; private set; }

    /// <summary>
    /// ItemUnit of the CustomerItemLimitSale
    /// ItemUnit الخاص بـ CustomerItemLimitSale
    /// </summary>
