...
public class SalesmanCommissionTypeMaster : Entity<SalesmanCommissionTypeMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: SalesmanCommissionTypeMaster to SalesmanCommissionDetail
    /// </summary>
    public IReadOnlyCollection<SalesmanCommissionDetail> SalesmanCommissionDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: SalesmanCommissionTypeMaster to SalesmanCommissionTypeDetail
    /// </summary>
    public IReadOnlyCollection<SalesmanCommissionTypeDetail> SalesmanCommissionTypeDetails { get; private set; }
    #endregion
}
}
