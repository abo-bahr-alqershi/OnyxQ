...
public class CouponTypeMaster : Entity<CouponTypeMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: CouponTypeMaster to CouponMaster
    /// </summary>
    public IReadOnlyCollection<CouponMaster> CouponMasters { get; private set; }
    /// <summary>
    /// One-to-many relationship: CouponTypeMaster to CouponTypeDetail
    /// </summary>
    public IReadOnlyCollection<CouponTypeDetail> CouponTypeDetails { get; private set; }
    #endregion
}
}
