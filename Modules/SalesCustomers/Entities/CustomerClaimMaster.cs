...
public class CustomerClaimMaster : Entity<CustomerClaimMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: CustomerClaimMaster to CustomerClaimDetail
    /// </summary>
    public IReadOnlyCollection<CustomerClaimDetail> CustomerClaimDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: CustomerClaimMaster to CustomerClaimVisit
    /// </summary>
    public IReadOnlyCollection<CustomerClaimVisit> CustomerClaimVisits { get; private set; }
    #endregion
}
}
