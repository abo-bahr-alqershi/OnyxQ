...
public class FreightDetail : Entity<FreightDetailId>
{
    ...
    /// <summary>
    /// ItemCode of the FreightDetail
    /// ItemCode الخاص بـ FreightDetail
    /// </summary>
    ...
    /// <summary>
    /// WarehouseCode of the FreightDetail
    /// WarehouseCode الخاص بـ FreightDetail
    /// </summary>
    ...
    /// <summary>
    /// FreightSerial of the FreightDetail
    /// FreightSerial الخاص بـ FreightDetail
    /// </summary>
    ...
    /// <summary>
    /// ManyToOne relationship to FreightMaster
    /// </summary>
    public FreightMaster FreightMaster { get; private set; }
    #endregion
}
}
