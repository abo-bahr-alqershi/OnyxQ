...
public class ReportUserTemplateDetail : Entity<ReportUserTemplateDetailId>
{
    ...
    /// <summary>
    /// FormNumber of the ReportUserTemplateDetail
    /// FormNumber الخاص بـ ReportUserTemplateDetail
    /// </summary>
    public decimal? FormNumber { get; private set; }

    /// <summary>
    /// UserId of the ReportUserTemplateDetail
    /// UserId الخاص بـ ReportUserTemplateDetail
    /// </summary>
    public decimal? UserId { get; private set; }

    /// <summary>
    /// TemplateNumber of the ReportUserTemplateDetail
    /// TemplateNumber الخاص بـ ReportUserTemplateDetail
    /// </summary>
    ...
    /// <summary>
    /// ManyToOne relationship to ReportUserTemplateMaster
    /// </summary>
