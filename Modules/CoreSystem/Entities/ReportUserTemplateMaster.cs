...
public class ReportUserTemplateMaster : Entity<ReportUserTemplateMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: ReportUserTemplateMaster to ReportUserTemplateDetail
    /// </summary>
    public IReadOnlyCollection<ReportUserTemplateDetail> ReportUserTemplateDetails { get; private set; }
    #endregion
}
}
