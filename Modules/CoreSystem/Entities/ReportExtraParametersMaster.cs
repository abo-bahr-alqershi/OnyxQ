...
public class ReportExtraParametersMaster : Entity<ReportExtraParametersMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: ReportExtraParametersMaster to ReportExtraParametersDetail
    /// </summary>
    public IReadOnlyCollection<ReportExtraParametersDetail> ReportExtraParametersDetails { get; private set; }
    #endregion
}
}
