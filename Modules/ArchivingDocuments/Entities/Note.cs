...
public class Note : Entity<NoteId>
{
    ...
    /// <summary>
    /// AccountCode of the Note
    /// AccountCode الخاص بـ Note
    /// </summary>
    ...
    /// <summary>
    /// AccountCurrency of the Note
    /// AccountCurrency الخاص بـ Note
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: Note to NoteDetail
    /// </summary>
    public IReadOnlyCollection<NoteDetail> NoteDetails { get; private set; }
    #endregion
}
}
