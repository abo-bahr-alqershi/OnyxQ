...
public class AnswerQuestionnaireMaster : Entity<AnswerQuestionnaireMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: AnswerQuestionnaireMaster to AnswerQuestionnaireDetail
    /// </summary>
    public IReadOnlyCollection<AnswerQuestionnaireDetail> AnswerQuestionnaireDetails { get; private set; }
    #endregion
}
}
