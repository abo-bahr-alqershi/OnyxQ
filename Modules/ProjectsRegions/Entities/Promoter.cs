...
public class Promoter : Entity<PromoterId>
{
    ...
    /// <summary>
    /// CountryNumber of the Promoter
    /// CountryNumber الخاص بـ Promoter
    /// </summary>
    public decimal? CountryNumber { get; private set; }

    /// <summary>
    /// CityNumber of the Promoter
    /// CityNumber الخاص بـ Promoter
    /// </summary>
    public decimal? CityNumber { get; private set; }

    /// <summary>
    /// RegionCode of the Promoter
    /// RegionCode الخاص بـ Promoter
    /// </summary>
    ...
    /// <summary>
    /// RepCode of the Promoter
    /// RepCode الخاص بـ Promoter
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: Promoter to Region
    /// </summary>
    public IReadOnlyCollection<Region> Regions { get; private set; }
    /// <summary>
    /// One-to-many relationship: Promoter to Salesman
    /// </summary>
