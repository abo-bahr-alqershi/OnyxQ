...
public class StationBillMaster : Entity<StationBillMasterId>
{
    ...
    /// <summary>
    /// CashNumber of the StationBillMaster
    /// CashNumber الخاص بـ StationBillMaster
    /// </summary>
    public decimal? CashNumber { get; private set; }

    /// <summary>
    /// AccountCurrency of the StationBillMaster
    /// AccountCurrency الخاص بـ StationBillMaster
    /// </summary>
    ...
    /// <summary>
    /// ColumnNumberShort of the StationBillMaster
    /// ColumnNumberShort الخاص بـ StationBillMaster
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: StationBillMaster to StationBillCoupon
    /// </summary>
    public IReadOnlyCollection<StationBillCoupon> StationBillCoupons { get; private set; }
    /// <summary>
    /// One-to-many relationship: StationBillMaster to StationBillCredit
    /// </summary>
    public IReadOnlyCollection<StationBillCredit> StationBillCredits { get; private set; }
    /// <summary>
    /// One-to-many relationship: StationBillMaster to StationBillDetail
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: StationBillMaster to StationBillCashPayment
    /// </summary>
    public IReadOnlyCollection<StationBillCashPayment> StationBillCashPayments { get; private set; }
    /// <summary>
    /// One-to-many relationship: StationBillMaster to StationOutgoingDetail
    /// </summary>
    public IReadOnlyCollection<StationOutgoingDetail> StationOutgoingDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: StationBillMaster to StationWarehouseTransferDetail
    /// </summary>
    public IReadOnlyCollection<StationWarehouseTransferDetail> StationWarehouseTransferDetails { get; private set; }
    #endregion
}
}
