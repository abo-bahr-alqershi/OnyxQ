...
public class StationCounter : Entity<StationCounterId>
{
    ...
    /// <summary>
    /// FuelTypeNumber of the StationCounter
    /// FuelTypeNumber الخاص بـ StationCounter
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: StationCounter to StationCounterEmployee
    /// </summary>
    public IReadOnlyCollection<StationCounterEmployee> StationCounterEmployees { get; private set; }
    /// <summary>
    /// One-to-many relationship: StationCounter to Employee
    /// </summary>
    public IReadOnlyCollection<Employee> Employees { get; private set; }
    /// <summary>
    /// One-to-many relationship: StationCounter to StationPeriod
    /// </summary>
