...
public class Employee : Entity<EmployeeId>
{
    ...
    /// <summary>
    /// EmpNoMngr of the Employee
    /// EmpNoMngr الخاص بـ Employee
    /// </summary>
    public decimal? EmpNoMngr { get; private set; }
    ...
    /// <summary>
    /// CurCode of the Employee
    /// CurCode الخاص بـ Employee
    /// </summary>
    public string CurCode { get; private set; }

    /// <summary>
    /// BranchNumber of the Employee
    /// BranchNumber الخاص بـ Employee
    /// </summary>
    ...
    /// <summary>
    /// HierarchyNumber of the Employee
    /// HierarchyNumber الخاص بـ Employee
    /// </summary>
    ...
    /// <summary>
    /// ProjectNumber of the Employee
    /// ProjectNumber الخاص بـ Employee
    /// </summary>
    ...
    /// <summary>
    /// CostCenterCode of the Employee
    /// CostCenterCode الخاص بـ Employee
    /// </summary>
    ...
    /// <summary>
    /// ActivityNumber of the Employee
    /// ActivityNumber الخاص بـ Employee
    /// </summary>
    ...
    /// <summary>
    /// EmpNoMngr2 of the Employee
    /// EmpNoMngr2 الخاص بـ Employee
    /// </summary>
    public decimal? EmpNoMngr2 { get; private set; }
    ...
    /// <summary>
    /// One-to-many relationship: Employee to ApprovalAppDevice
    /// </summary>
    public IReadOnlyCollection<ApprovalAppDevice> ApprovalAppDevices { get; private set; }
    /// <summary>
    /// One-to-many relationship: Employee to ReturnBillDetailRequest
    /// </summary>
    public IReadOnlyCollection<ReturnBillDetailRequest> ReturnBillDetailRequests { get; private set; }
    /// <summary>
    /// One-to-many relationship: Employee to ReturnBillMasterRequest
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: Employee to Employee
    /// </summary>
    public IReadOnlyCollection<Employee> Employees { get; private set; }
    /// <summary>
    /// ManyToOne relationship to Hierarchy
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: Employee to EmployeeAttendanceLocation
    /// </summary>
    public IReadOnlyCollection<EmployeeAttendanceLocation> EmployeeAttendanceLocations { get; private set; }
    /// <summary>
    /// One-to-many relationship: Employee to EmployeeBank
    /// </summary>
    public IReadOnlyCollection<EmployeeBank> EmployeeBanks { get; private set; }
    /// <summary>
    /// One-to-many relationship: Employee to EmployeeFamily
    /// </summary>
    public IReadOnlyCollection<EmployeeFamily> EmployeeFamilies { get; private set; }
    /// <summary>
    /// One-to-many relationship: Employee to EmployeeGuarantor
    /// </summary>
    public IReadOnlyCollection<EmployeeGuarantor> EmployeeGuarantors { get; private set; }
    /// <summary>
    /// One-to-many relationship: Employee to EmployeeHolidayBalance
    /// </summary>
    public IReadOnlyCollection<EmployeeHolidayBalance> EmployeeHolidayBalances { get; private set; }
    /// <summary>
    /// One-to-many relationship: Employee to EmployeeHandheldDevice
    /// </summary>
    public IReadOnlyCollection<EmployeeHandheldDevice> EmployeeHandheldDevices { get; private set; }
    /// <summary>
    /// OneToOne relationship to EmployeeImage
    /// </summary>
    public EmployeeImage EmployeeImage { get; private set; }
    /// <summary>
    /// One-to-many relationship: Employee to EmployeeKnowledge
    /// </summary>
    public IReadOnlyCollection<EmployeeKnowledge> EmployeeKnowledges { get; private set; }
    /// <summary>
    /// One-to-many relationship: Employee to EmployeeRelativeTickets
    /// </summary>
    public IReadOnlyCollection<EmployeeRelativeTickets> EmployeeRelativeTicketses { get; private set; }
    /// <summary>
    /// One-to-many relationship: Employee to EmployeeSponsor
    /// </summary>
    public IReadOnlyCollection<EmployeeSponsor> EmployeeSponsors { get; private set; }
    /// <summary>
    /// One-to-many relationship: Employee to StationCounterEmployee
    /// </summary>
    public IReadOnlyCollection<StationCounterEmployee> StationCounterEmployees { get; private set; }
    /// <summary>
    /// One-to-many relationship: Employee to StationJournalDiffEmployeeDetail
    /// </summary>
    public IReadOnlyCollection<StationJournalDiffEmployeeDetail> StationJournalDiffEmployeeDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: Employee to StationOutgoingDetail
    /// </summary>
    public IReadOnlyCollection<StationOutgoingDetail> StationOutgoingDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: Employee to ReceiptDocument
    /// </summary>
    public IReadOnlyCollection<ReceiptDocument> ReceiptDocuments { get; private set; }
    /// <summary>
    /// One-to-many relationship: Employee to GeneralAttendanceLocation
    /// </summary>
    public IReadOnlyCollection<GeneralAttendanceLocation> GeneralAttendanceLocations { get; private set; }
    /// <summary>
    /// One-to-many relationship: Employee to StationCounter
    /// </summary>
    public IReadOnlyCollection<StationCounter> StationCounters { get; private set; }
    /// <summary>
    /// One-to-many relationship: Employee to StationPeriod
    /// </summary>
    public IReadOnlyCollection<StationPeriod> StationPeriods { get; private set; }
    #endregion
}
}
