...
public class LetterOfCreditMaster : Entity<LetterOfCreditMasterId>
{
    ...
    /// <summary>
    /// BankNumber of the LetterOfCreditMaster
    /// BankNumber الخاص بـ LetterOfCreditMaster
    /// </summary>
    ...
    /// <summary>
    /// LetterCreditAccount of the LetterOfCreditMaster
    /// LetterCreditAccount الخاص بـ LetterOfCreditMaster
    /// </summary>
    public string LetterCreditAccount { get; private set; }

    /// <summary>
    /// LetterCreditAccountCurrency of the LetterOfCreditMaster
    /// LetterCreditAccountCurrency الخاص بـ LetterOfCreditMaster
    /// </summary>
    public string LetterCreditAccountCurrency { get; private set; }
    ...
    /// <summary>
    /// VendorCode of the LetterOfCreditMaster
    /// VendorCode الخاص بـ LetterOfCreditMaster
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: LetterOfCreditMaster to JournalFileDetail
    /// </summary>
    public IReadOnlyCollection<JournalFileDetail> JournalFileDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: LetterOfCreditMaster to GeneralLedgerRequestExchangeCurrencyDetail
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: LetterOfCreditMaster to JournalVoucherDetail
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: LetterOfCreditMaster to ExchangeCurrencyDetail
    /// </summary>
    public IReadOnlyCollection<ExchangeCurrencyDetail> ExchangeCurrencyDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: LetterOfCreditMaster to PostDetail
    /// </summary>
    public IReadOnlyCollection<PostDetail> PostDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: LetterOfCreditMaster to GuaranteeDetail
    /// </summary>
    public IReadOnlyCollection<GuaranteeDetail> GuaranteeDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: LetterOfCreditMaster to RequestJournalDetail
    /// </summary>
    public IReadOnlyCollection<RequestJournalDetail> RequestJournalDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: LetterOfCreditMaster to RequestVoucherDetail
    /// </summary>
    public IReadOnlyCollection<RequestVoucherDetail> RequestVoucherDetails { get; private set; }
    /// <summary>
    /// One-to-many relationship: LetterOfCreditMaster to LetterOfCreditDetail
    /// </summary>
