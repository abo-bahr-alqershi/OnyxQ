...
public class JudicialFieldOrderMaster : Entity<JudicialFieldOrderMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: JudicialFieldOrderMaster to JudicialFieldOrderDetail
    /// </summary>
    public IReadOnlyCollection<JudicialFieldOrderDetail> JudicialFieldOrderDetails { get; private set; }
    #endregion
}
}
