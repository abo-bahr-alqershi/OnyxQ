...
public class AuditAccountDetail : Entity<AuditAccountDetailId>
{
    ...
    /// <summary>
    /// AuditNumber of the AuditAccountDetail
    /// AuditNumber الخاص بـ AuditAccountDetail
    /// </summary>
    public decimal? AuditNumber { get; private set; }

    /// <summary>
    /// AuditType of the AuditAccountDetail
    /// AuditType الخاص بـ AuditAccountDetail
    /// </summary>
    ...
    /// <summary>
    /// ManyToOne relationship to AuditAccountMaster
    /// </summary>
