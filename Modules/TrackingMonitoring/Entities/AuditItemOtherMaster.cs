...
public class AuditItemOtherMaster : Entity<AuditItemOtherMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: AuditItemOtherMaster to AuditItemOtherDetail
    /// </summary>
    public IReadOnlyCollection<AuditItemOtherDetail> AuditItemOtherDetails { get; private set; }
    #endregion
}
}
