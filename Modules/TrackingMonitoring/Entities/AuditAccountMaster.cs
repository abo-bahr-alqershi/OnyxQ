...
/// </summary>
public class AuditAccountMaster : Entity<AuditAccountMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: AuditAccountMaster to AuditAccountDetail
    /// </summary>
    public IReadOnlyCollection<AuditAccountDetail> AuditAccountDetails { get; private set; }
    #endregion
}
}
