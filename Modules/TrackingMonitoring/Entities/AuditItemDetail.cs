...
public class AuditItemDetail : Entity<AuditItemDetailId>
{
    ...
    /// <summary>
    /// AuditNumber of the AuditItemDetail
    /// AuditNumber الخاص بـ AuditItemDetail
    /// </summary>
    public decimal? AuditNumber { get; private set; }

    /// <summary>
    /// AuditType of the AuditItemDetail
    /// AuditType الخاص بـ AuditItemDetail
    /// </summary>
    ...
    /// <summary>
    /// ManyToOne relationship to AuditItemMaster
    /// </summary>
