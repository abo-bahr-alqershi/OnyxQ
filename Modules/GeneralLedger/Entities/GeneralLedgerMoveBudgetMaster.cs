...
public class GeneralLedgerMoveBudgetMaster : Entity<GeneralLedgerMoveBudgetMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: GeneralLedgerMoveBudgetMaster to GeneralLedgerMoveBudgetDetail
    /// </summary>
    public IReadOnlyCollection<GeneralLedgerMoveBudgetDetail> GeneralLedgerMoveBudgetDetails { get; private set; }
    #endregion
}
}
