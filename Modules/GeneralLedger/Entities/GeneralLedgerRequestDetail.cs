...
public class GeneralLedgerRequestDetail : Entity<GeneralLedgerRequestDetailId>
{
    ...
    /// <summary>
    /// DocSer of the GeneralLedgerRequestDetail
    /// DocSer الخاص بـ GeneralLedgerRequestDetail
    /// </summary>
    ...
    /// <summary>
    /// ActivityNumber of the GeneralLedgerRequestDetail
    /// ActivityNumber الخاص بـ GeneralLedgerRequestDetail
    /// </summary>
    ...
    /// <summary>
    /// ManyToOne relationship to GeneralLedgerRequestMaster
    /// </summary>
    public GeneralLedgerRequestMaster GeneralLedgerRequestMaster { get; private set; }
    #endregion
}
}
