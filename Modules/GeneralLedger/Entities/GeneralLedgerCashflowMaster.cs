...
public class GeneralLedgerCashflowMaster : Entity<GeneralLedgerCashflowMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: GeneralLedgerCashflowMaster to GeneralLedgerCashflowDetail
    /// </summary>
    public IReadOnlyCollection<GeneralLedgerCashflowDetail> GeneralLedgerCashflowDetails { get; private set; }
    #endregion
}
}
