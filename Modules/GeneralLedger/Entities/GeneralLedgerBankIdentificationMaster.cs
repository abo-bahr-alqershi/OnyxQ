...
public class GeneralLedgerBankIdentificationMaster : Entity<GeneralLedgerBankIdentificationMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: GeneralLedgerBankIdentificationMaster to GeneralLedgerBankIdentificationDetail
    /// </summary>
    public IReadOnlyCollection<GeneralLedgerBankIdentificationDetail> GeneralLedgerBankIdentificationDetails { get; private set; }
    #endregion
}
}
