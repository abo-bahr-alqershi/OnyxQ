...
public class GeneralLedgerAccountDetail : Entity<GeneralLedgerAccountDetailId>
{
    ...
    /// <summary>
    /// GroupCode of the GeneralLedgerAccountDetail
    /// GroupCode الخاص بـ GeneralLedgerAccountDetail
    /// </summary>
    public decimal? GroupCode { get; private set; }

    /// <summary>
    /// AccountCode of the GeneralLedgerAccountDetail
    /// AccountCode الخاص بـ GeneralLedgerAccountDetail
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: GeneralLedgerAccountDetail to GeneralLedgerAccountDetailCurrency
    /// </summary>
    public IReadOnlyCollection<GeneralLedgerAccountDetailCurrency> GeneralLedgerAccountDetailCurrencies { get; private set; }
    /// <summary>
    /// One-to-many relationship: GeneralLedgerAccountDetail to ExchangeRate
    /// </summary>
