...
public class GeneralLedgerRequestTypes : Entity<GeneralLedgerRequestTypesId>
{
    ...
    /// <summary>
    /// One-to-many relationship: GeneralLedgerRequestTypes to GeneralLedgerRequestTypesPrivilege
    /// </summary>
    public IReadOnlyCollection<GeneralLedgerRequestTypesPrivilege> GeneralLedgerRequestTypesPrivileges { get; private set; }
    /// <summary>
    /// One-to-many relationship: GeneralLedgerRequestTypes to RequestJournalMaster
    /// </summary>
    public IReadOnlyCollection<RequestJournalMaster> RequestJournalMasters { get; private set; }
    /// <summary>
    /// One-to-many relationship: GeneralLedgerRequestTypes to RequestVoucherMaster
    /// </summary>
    public IReadOnlyCollection<RequestVoucherMaster> RequestVoucherMasters { get; private set; }
    /// <summary>
    /// One-to-many relationship: GeneralLedgerRequestTypes to User
    /// </summary>
