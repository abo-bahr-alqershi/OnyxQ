...
public class GeneralLedgerAccountDetailGroups : Entity<GeneralLedgerAccountDetailGroupsId>
{
    ...
    /// <summary>
    /// GroupAccountCode of the GeneralLedgerAccountDetailGroups
    /// GroupAccountCode الخاص بـ GeneralLedgerAccountDetailGroups
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: GeneralLedgerAccountDetailGroups to GeneralLedgerAccountCodeDetailGroups
    /// </summary>
    public IReadOnlyCollection<GeneralLedgerAccountCodeDetailGroups> GeneralLedgerAccountCodeDetailGroupses { get; private set; }
    #endregion
}
}
