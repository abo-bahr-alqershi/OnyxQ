...
public class GeneralLedgerCashflowDetail : Entity<GeneralLedgerCashflowDetailId>
{
    ...
    /// <summary>
    /// DocSer of the GeneralLedgerCashflowDetail
    /// DocSer الخاص بـ GeneralLedgerCashflowDetail
    /// </summary>
    ...
    /// <summary>
    /// One-to-many relationship: GeneralLedgerCashflowDetail to GeneralLedgerCashflowAccount
    /// </summary>
    public IReadOnlyCollection<GeneralLedgerCashflowAccount> GeneralLedgerCashflowAccounts { get; private set; }
    /// <summary>
    /// ManyToOne relationship to GeneralLedgerCashflowMaster
    /// </summary>
