...
public class GeneralLedgerBankChequeDetail : Entity<GeneralLedgerBankChequeDetailId>
{
    ...
    /// <summary>
    /// BankNumber of the GeneralLedgerBankChequeDetail
    /// BankNumber الخاص بـ GeneralLedgerBankChequeDetail
    /// </summary>
    public decimal? BankNumber { get; private set; }

    /// <summary>
    /// CurCode of the GeneralLedgerBankChequeDetail
    /// CurCode الخاص بـ GeneralLedgerBankChequeDetail
    /// </summary>
    public string CurCode { get; private set; }

    /// <summary>
    /// BookNumber of the GeneralLedgerBankChequeDetail
    /// BookNumber الخاص بـ GeneralLedgerBankChequeDetail
    /// </summary>
    ...
    /// <summary>
    /// ManyToOne relationship to GeneralLedgerBankChequeMaster
    /// </summary>
