...
public class ParameterReportMaster : Entity<ParameterReportMasterId>
{
    ...
    /// <summary>
    /// One-to-many relationship: ParameterReportMaster to ParameterReportDetail
    /// </summary>
    public IReadOnlyCollection<ParameterReportDetail> ParameterReportDetails { get; private set; }
    #endregion
}
}
