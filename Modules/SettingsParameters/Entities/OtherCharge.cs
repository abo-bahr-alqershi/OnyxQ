...
public class OtherCharge : Entity<OtherChargeId>
{
    ...
    /// <summary>
    /// ServiceNumber of the OtherCharge
    /// ServiceNumber الخاص بـ OtherCharge
    /// </summary>
    public decimal? ServiceNumber { get; private set; }

    /// <summary>
    /// AccountCode of the OtherCharge
    /// AccountCode الخاص بـ OtherCharge
    /// </summary>
    public string AccountCode { get; private set; }

    /// <summary>
    /// AccountCurrency of the OtherCharge
    /// AccountCurrency الخاص بـ OtherCharge
    /// </summary>
