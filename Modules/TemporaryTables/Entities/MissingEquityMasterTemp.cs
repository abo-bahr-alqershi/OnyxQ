...
public class MissingEquityMasterTemp : Entity<MissingEquityMasterTempId>
{
    ...
    /// <summary>
    /// One-to-many relationship: MissingEquityMasterTemp to MissingEquityDetailTemp
    /// </summary>
    public IReadOnlyCollection<MissingEquityDetailTemp> MissingEquityDetailTemps { get; private set; }
    #endregion
}
}
